...
module.exports=(context) => {
	...
	context.subscriptions.push(vscode.commands.registerCommand('mycommand.webview.hello', ()=>{
    ...
    if (vscode.workspace.getConfiguration("mycommandPlugin").get("ShowTip")) {
        vscode.commands.executeCommand('mycommand.webview.hello');  //执行命令
    }
}
